...
image jingzhe faint_smile = Transform("images/characters/jingzhe_faint_smile_3q_thigh_no_kiseru.png", zoom=0.44)
...
image jingzhe shocked = Transform("images/characters/jingzhe_shocked_3q_thigh_no_kiseru.png", zoom=0.44)
...
image hanami bright = Transform("images/characters/hanami_bright_3q_full_unarmed.png", zoom=0.44)
image hanami curious = Transform("images/characters/hanami_curious_3q_full_unarmed.png", zoom=0.44)
image hanami concerned = Transform("images/characters/hanami_concerned_3q_full_unarmed.png", zoom=0.44)
...
image hanami shaken = Transform("images/characters/hanami_shaken_3q_full_unarmed.png", zoom=0.44)
image hanami determined = Transform("images/characters/hanami_determined_3q_full_unarmed.png", zoom=0.44)
image hanami battle = Transform("images/characters/hanami_battle_injured_3q_full_unarmed.png", zoom=0.44)
image hanami injured = Transform("images/characters/hanami_injured_3q_full_unarmed.png", zoom=0.44)
...
image hanami angry = Transform("images/characters/hanami_angry_3q_full_unarmed.png", zoom=0.44)
image hanami tearful = Transform("images/characters/hanami_true_end_tearful_3q_full_unarmed.png", zoom=0.44)

image yumemi gentle = Transform("images/characters/yumemi_gentle_3q_full_unarmed.png", zoom=0.44)
image yumemi shy = Transform("images/characters/yumemi_shy_3q_full_unarmed.png", zoom=0.44)
image yumemi worried = Transform("images/characters/yumemi_worried_3q_full_unarmed.png", zoom=0.44)
...
image yumemi ashamed = Transform("images/characters/yumemi_ashamed_3q_full_unarmed.png", zoom=0.44)
image yumemi determined = Transform("images/characters/yumemi_determined_3q_full_unarmed.png", zoom=0.44)
image yumemi grief = Transform("images/characters/yumemi_grief_3q_full_unarmed.png", zoom=0.44)
image yumemi surprised = Transform("images/characters/yumemi_surprised_3q_full_unarmed.png", zoom=0.44)
...
image achirichi serious = Transform("images/characters/achirichi_serious_3q_full_no_prop.png", zoom=0.44)

image tsuchigumo looming = Transform("images/characters/tsuchigumo_looming_full_no_prop.png", zoom=0.44)
...
image shadow_witch cold = Transform("images/characters/shadow_witch_annoyed_3q_full_holding_card.png", zoom=0.44)
image shadow_witch annoyed = Transform("images/characters/shadow_witch_annoyed_3q_full_holding_card.png", zoom=0.44)
image shadow_witch concerned = Transform("images/characters/shadow_witch_annoyed_3q_full_holding_card.png", zoom=0.44)
