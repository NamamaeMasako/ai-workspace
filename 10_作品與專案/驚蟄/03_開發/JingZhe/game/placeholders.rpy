...
image jingzhe faint_smile = Transform("images/characters/jingzhe_softened_3q_full_no_kiseru.png", zoom=0.44)
...
image jingzhe shocked = Transform("images/characters/jingzhe_wary_3q_thigh_no_kiseru.png", zoom=0.44)
...
image hanami bright = Transform("images/characters/hanami_possessed_sweet_3q_full_unarmed.png", zoom=0.44)
image hanami curious = Transform("images/characters/hanami_revelation_surprised_3q_full_unarmed.png", zoom=0.44)
image hanami concerned = Transform("images/characters/hanami_grief_3q_full_unarmed.png", zoom=0.44)
...
image hanami shaken = Transform("images/characters/hanami_grief_3q_full_unarmed.png", zoom=0.44)
image hanami determined = Transform("images/characters/hanami_battle_injured_3q_full_unarmed.png", zoom=0.44)
...
image hanami angry = Transform("images/characters/hanami_battle_injured_3q_full_unarmed.png", zoom=0.44)
image hanami tearful = Transform("images/characters/hanami_true_end_tearful_3q_full_unarmed.png", zoom=0.44)

image yumemi gentle = Transform("images/characters/yumemi_true_end_tearful_3q_full_unarmed.png", zoom=0.44)
image yumemi shy = Transform("images/characters/yumemi_true_end_tearful_3q_full_unarmed.png", zoom=0.44)
image yumemi worried = Transform("images/characters/yumemi_grief_3q_full_unarmed.png", zoom=0.44)
...
image yumemi ashamed = Transform("images/characters/yumemi_grief_3q_full_unarmed.png", zoom=0.44)
image yumemi determined = Transform("images/characters/yumemi_true_end_tearful_3q_full_unarmed.png", zoom=0.44)
image yumemi grief = Transform("images/characters/yumemi_grief_3q_full_unarmed.png", zoom=0.44)
image yumemi surprised = Transform("images/characters/yumemi_frightened_3q_full_unarmed.png", zoom=0.44)
...
image achirichi serious = Transform("images/characters/achirichi_first_meeting_calm_3q_full_no_prop.png", zoom=0.44)

image tsuchigumo looming = Transform("images/characters/tsuchigumo_frontal_lunge_full_battle_no_prop.png", zoom=0.44)
